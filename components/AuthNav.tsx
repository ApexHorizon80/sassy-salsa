...
export function AuthNav() {
  ...
  return email ? <><a href="/account">Account</a><button className="text-link" onClick={signOut}>Sign Out</button></> : <><a href="/sign-in">Sign In</a><a href="/create-account">Create Account</a></>;
}
